...
def main(args):
    ...
    # LightningModule化
    pl_model = NFModule(sample_num=args.sample_num)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--project', type=str, default='3dshapes-normflows', help='wandb project name')
    parser.add_argument('--ckpt_dir', type=str, default='checkpoints/flow', help='Checkpoint directory')
